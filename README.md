...
<body>
  ...
  },
  {
    ...
    a: `▪ ビュッフェ形式で中華・洋食・和食をご用意しております。<br>
        ...
        ▪ ビュッフェ形式で、ベジタリアン対応は一部のみとなります。<br>
        ▪ 朝食はお一人様 NT$495 です。<br><br>
        ⭐春節の繁忙時間帯は、ご利用時間を 1時間 とさせていただきます。
        ⭐春節期間中は料金が異なる場合がございます。`
  },
  {
  ...
  },
  {
    ...
    a: `▪ 宿泊のチェックインは⭐20歳以上の方に限ります。`
       ...
       {
        q: "ペットと一緒に宿泊できますか。？",
        a: `▪ 誠に申し訳ございませんが、当ホテルではペット同伴でのご宿泊はお断りしております。
ただし、盲導犬などの補助犬はご同伴いただけます。`
      },
  {
    q: "平日と休日の定義は？",
